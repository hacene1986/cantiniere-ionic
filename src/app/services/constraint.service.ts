...
export class ConstraintService {
  ...
  addConstraint(constraint: Constraint): Observable<Constraint> {
    return this.httpClient.put<Constraint>(
      environment.urlServeurBackEnd + "constraint/add",
      constraint
    );
  }
  ...
  deleteConstraint(constraint: Constraint): Observable<Constraint> {
    return this.httpClient.delete<Constraint>(
      environment.urlServeurBackEnd + "constraint/delete/" + constraint
    );
  }

  // Méthode pour récuperer une contrainte
  getConstraint(constraint: Constraint): Observable<Constraint> {
    return this.httpClient.get<Constraint>(
      environment.urlServeurBackEnd + "constraint/find/" + constraint.id
    );
  }
  ...
  getAllConstraint(): Observable<Constraint[]> {
    return this.httpClient.get<Constraint[]>(
      environment.urlServeurBackEnd + "constraint/findall/"
    );
  }
  ...
  updateConstraint(
    ...
    return this.httpClient.patch<Constraint>(
      environment.urlServeurBackEnd + "constraint/update/" + constraintId,
      constraint
    );
  }
}
