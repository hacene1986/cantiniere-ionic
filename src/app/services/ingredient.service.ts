...
export class Ingredientervice {
  ...
  addIngredient(ingredient: Ingredient): Observable<Ingredient> {
    return this.httpClient.put<Ingredient>(
      environment.urlServeurBackEnd + "ingredient/add",
      ingredient
    );
  }
  ...
  deleteIngredient(ingredient: Ingredient): Observable<Ingredient> {
    return this.httpClient.delete<Ingredient>(
      environment.urlServeurBackEnd + "ingredient/delete/" + ingredient
    );
  }
  ...
  getIngredient(ingredient: Ingredient): Observable<Ingredient> {
    return this.httpClient.get<Ingredient>(
      environment.urlServeurBackEnd + "ingredient/find/" + ingredient.id
    );
  }
  ...
  getAllIngredient(): Observable<Ingredient[]> {
    return this.httpClient.get<Ingredient[]>(
      environment.urlServeurBackEnd + "ingredient/findall/"
    );
  }
  ...
  updateIngredient(
    ...
    return this.httpClient.patch<Ingredient>(
      environment.urlServeurBackEnd + "Ingredient/update/" + ingredientId,
      Ingredient
    );
  }
}
